...
const TABLAS = [
  ...
  },
  {
    ...
    desc: "Papas fritas, chorizo, longaniza, lomo liso, pulpa de cerdo BBQ.",
  ...
  {
    name: "Tabla Completa",
    desc: "Papas fritas, lomo liso, pollo, chorizo, vienesa, nuggets, aros de cebolla, queso.",
    price: "Mediana $19.000 · Grande $25.000",
    photo: "tablas/completa"
  },
  {
    name: "Mar y Tierra",
...
const CAFES_CALIENTES = [
  ...
  { name: "Americano", photo: "cafes/americano" },
  {
    ...
    prompt:
      ...
      "creamy foam top, dusted with cinnamon and cocoa powder, with a drizzle of caramel syrup. " +
      "Elegant and natural. ABSOLUTELY NO bright coloured sauces, NO red, green or rainbow " +
      "drizzle, NO artificial food colouring. Seen from a 45-degree angle."
  },
  { name: "Cortado", photo: "cafes/cortado" },
  { name: "Capuccino", photo: "cafes/capuccino" },
  {
    name: "Té Supremo",
    price: "$1.900",
...
export const SECTIONS = [
  {
    id: "pizzas",
    title: "Pizzas",
    subtitle: "Individual $7.000 · Familiar $10.500 · XL $13.500",
    photoStyle: "pizza",
    items: PIZZAS
  },
  {
