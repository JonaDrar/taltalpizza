...
const APERITIVOS = [
  ...
  },
  {
    ...
    // Empanadita chilena de queso: masa frita, redonda y pequeña, no la empanada
    // de horno grande ni la argentina repulgada.
    prompt:
      "A portion of eight small round Chilean fried cheese empanadas (empanaditas de queso), " +
      "golden and blistered, piled on a rustic plate, one broken open showing the melted cheese " +
      "inside. ONLY the small fried cheese empanadas and nothing else: NO dipping sauce, NO salsa, " +
      "NO pebre, NO salad, NO fries, NO garnish, NO large baked empanadas. " +
      "Seen from a 45-degree angle."
  }
];
